...
% Script Summary:
    % The purpose of this script is to import the data gathered from that
    % experiment, remove invalid trials, and then plot the valid data into
    % a trace plot. 

% Author:           Matthew R. DeVerna        
% Contact Email:    mrd518@nyu.edu
% Date Created:     06/08/2019 (mm/dd/yyyy)

% Revision History (date format: mm/dd/yyyy)

% Revision #: Original
% Date of change    % Author        % Description
% 06/08/2019        % M. DeVerna    % Script Creation
...
% The Variables Being Loaded:
    ...
    % conditions are captured in the below variables (loaded via "0.b"):
    ...
    % measure (in ms) was captured in the below variables - also loaded by "0.b"):
